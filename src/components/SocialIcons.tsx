...
export const DiscordIcon: React.FC<IconProps> = ({ className = 'w-4 h-4' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M18 6h0a14.5 14.5 0 0 0-4-1.5 9.8 9.8 0 0 0-.5 1.5 13.9 13.9 0 0 0-3 0 9.8 9.8 0 0 0-.5-1.5 14.5 14.5 0 0 0-4 1.5C3.5 10.5 3 15 3 19a14.5 14.5 0 0 0 4.5 2.2c.4-.5.7-1.1 1-1.7-.5-.2-1-.5-1.5-.8.1-.1.2-.2.3-.3 3 1.4 6.4 1.4 9.4 0 .1.1.2.2.3.3-.5.3-1 .6-1.5.8.3.6.6 1.2 1 1.7A14.5 14.5 0 0 0 21 19c0-4-.5-8.5-3-13z" />
